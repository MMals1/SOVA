...
function setPendingMnemonic(m) {
  _pendingMnemonic = m;
}
function getPendingMnemonic() {
...
export const WolfPopupQuizFlow = {
  setPendingMnemonic,
  getPendingMnemonic,
  copyMnemonic,
  confirmMnemonic,
...
globalThis.WolfPopupQuizFlow = WolfPopupQuizFlow;
